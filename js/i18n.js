...
const translations = {
  it: {
    ...
    loginHaveAccount: 'Hai già un account?',
    loginLoginLink: 'Accedi',
    registerTitle: 'Crea Account',
    registerUsernamePlaceholder: 'Scegli un username',
    registerEmailPlaceholder: 'Email (opzionale)',
    registerPasswordPlaceholder: 'Scegli una password',
    registerPasswordConfirmPlaceholder: 'Conferma password',
    registerButton: 'Crea Account',
    registerErrorRequired: 'Username e password sono obbligatori',
    registerErrorUsernameLength: 'Lo username deve essere tra 3 e 32 caratteri',
    registerErrorUsernameFormat: 'Lo username può contenere solo lettere, numeri, punti e _',
    registerErrorPasswordLength: 'La password deve essere almeno 6 caratteri',
    registerErrorPasswordMatch: 'Le password non corrispondono',
    registerErrorServer: 'Server non raggiungibile. Riprova.',
...
╚══════════════════════════════════════╝`,
  ...
  en: {
    ...
    loginLoginLink: 'Sign In',
    registerTitle: 'Create Account',
    registerUsernamePlaceholder: 'Choose a username',
    registerEmailPlaceholder: 'Email (optional)',
    registerPasswordPlaceholder: 'Choose a password',
    registerPasswordConfirmPlaceholder: 'Confirm password',
    registerButton: 'Create Account',
    registerErrorRequired: 'Username and password are required',
    registerErrorUsernameLength: 'Username must be between 3 and 32 characters',
    registerErrorUsernameFormat: 'Username can only contain letters, numbers, dots and _',
    registerErrorPasswordLength: 'Password must be at least 6 characters',
    registerErrorPasswordMatch: 'Passwords do not match',
    registerErrorServer: 'Server unreachable. Try again.',
    newChat: 'New Chat',
    modeGeneral: 'General',
    modeCoding: 'Coding',
...
╚══════════════════════════════════════╝`,
  ...
  fr: {
    ...
    loginHaveAccount: 'Déjà un compte ?',
    loginLoginLink: 'Se connecter',
    registerTitle: 'Créer un compte',
    registerUsernamePlaceholder: 'Choisissez un nom d\'utilisateur',
    registerEmailPlaceholder: 'Email (optionnel)',
    registerPasswordPlaceholder: 'Choisissez un mot de passe',
    registerPasswordConfirmPlaceholder: 'Confirmez le mot de passe',
    registerButton: 'Créer un compte',
    registerErrorRequired: 'Nom d\'utilisateur et mot de passe requis',
    registerErrorUsernameLength: 'Le nom d\'utilisateur doit contenir entre 3 et 32 caractères',
    registerErrorUsernameFormat: 'Le nom d\'utilisateur ne peut contenir que des lettres, chiffres, points et _',
    registerErrorPasswordLength: 'Le mot de passe doit contenir au moins 6 caractères',
    registerErrorPasswordMatch: 'Les mots de passe ne correspondent pas',
    registerErrorServer: 'Serveur inaccessible. Réessayez.',
...
╚══════════════════════════════════════╝`,
  ...
  de: {
    ...
    loginHaveAccount: 'Bereits ein Konto?',
    loginLoginLink: 'Anmelden',
    registerTitle: 'Konto erstellen',
    registerUsernamePlaceholder: 'Benutzername wählen',
    registerEmailPlaceholder: 'E-Mail (optional)',
    registerPasswordPlaceholder: 'Passwort wählen',
    registerPasswordConfirmPlaceholder: 'Passwort bestätigen',
    registerButton: 'Konto erstellen',
    registerErrorRequired: 'Benutzername und Passwort sind erforderlich',
    registerErrorUsernameLength: 'Der Benutzername muss zwischen 3 und 32 Zeichen lang sein',
    registerErrorUsernameFormat: 'Der Benutzername darf nur Buchstaben, Zahlen, Punkte und _ enthalten',
    registerErrorPasswordLength: 'Das Passwort muss mindestens 6 Zeichen lang sein',
    registerErrorPasswordMatch: 'Die Passwörter stimmen nicht überein',
    registerErrorServer: 'Server nicht erreichbar. Versuchen Sie es erneut.',
    newChat: 'Neuer Chat',
...
╚══════════════════════════════════════╝`,
  ...
  es: {
    ...
    loginLoginLink: 'Inicia sesión',
    registerTitle: 'Crear cuenta',
    registerUsernamePlaceholder: 'Elige un nombre de usuario',
    registerEmailPlaceholder: 'Email (opcional)',
    registerPasswordPlaceholder: 'Elige una contraseña',
    registerPasswordConfirmPlaceholder: 'Confirma contraseña',
    registerButton: 'Crear cuenta',
    registerErrorRequired: 'Usuario y contraseña son obligatorios',
    registerErrorUsernameLength: 'El usuario debe tener entre 3 y 32 caracteres',
    registerErrorUsernameFormat: 'El usuario solo puede contener letras, números, puntos y _',
    registerErrorPasswordLength: 'La contraseña debe tener al menos 6 caracteres',
    registerErrorPasswordMatch: 'Las contraseñas no coinciden',
    registerErrorServer: 'Servidor no disponible. Inténtalo de nuevo.',
    newChat: 'Nuevo Chat',
    modeGeneral: 'General',
...
╚══════════════════════════════════════╝`,
  ...
  ar: {
    ...
    loginRegisterLink: 'سجّل',
    loginHaveAccount: 'لديك حساب بالفعل؟',
    loginLoginLink: 'تسجيل الدخول',
    registerTitle: 'إنشاء حساب',
    registerUsernamePlaceholder: 'اختر اسم مستخدم',
    registerEmailPlaceholder: 'البريد الإلكتروني (اختياري)',
    registerPasswordPlaceholder: 'اختر كلمة مرور',
    registerPasswordConfirmPlaceholder: 'تأكيد كلمة المرور',
    registerButton: 'إنشاء حساب',
    registerErrorRequired: 'اسم المستخدم وكلمة المرور مطلوبان',
    registerErrorUsernameLength: 'اسم المستخدم يجب أن يكون بين 3 و 32 حرفاً',
    registerErrorUsernameFormat: 'اسم المستخدم يمكن أن يحتوي فقط على أحرف وأرقام ونقاط و _',
    registerErrorPasswordLength: 'كلمة المرور يجب أن تكون 6 أحرف على الأقل',
    registerErrorPasswordMatch: 'كلمات المرور غير متطابقة',
    registerErrorServer: 'الخادم غير متاح. حاول مرة أخرى.',
...
function applyTranslations() {
  ...
  const loginSwitch = document.querySelector('#login-form-section .login-switch');
  if (loginSwitch) loginSwitch.innerHTML = `${t('loginNoAccount')} <a href="#" onclick="showRegisterForm(); return false;" class="login-link">${t('loginRegisterLink')}</a>`;
  const registerSwitch = document.querySelector('#register-form-section .login-switch');
  if (registerSwitch) registerSwitch.innerHTML = `${t('loginHaveAccount')} <a href="#" onclick="showLoginForm(); return false;" class="login-link">${t('loginLoginLink')}</a>`;

  // Register form
  setAttr('#register-username', 'placeholder', t('registerUsernamePlaceholder'));
  setAttr('#register-email', 'placeholder', t('registerEmailPlaceholder'));
  setAttr('#register-password', 'placeholder', t('registerPasswordPlaceholder'));
  setAttr('#register-password-confirm', 'placeholder', t('registerPasswordConfirmPlaceholder'));
  setText('#register-btn span', t('registerButton'));
